...
VIEWPORT = ['720,1440', '720,1080', '460,900', '1536,864', '1366,768', '1280,1024', '1024,768']
...
def get_driver(proxy=None, mobile_simulation=True):
    background = True
    ...
    agent_1 = [generate_user_agent(device_type='smartphone', navigator=['chrome']), UserAgent()]
    agents_2 = [UserAgent(os_family='ios').random(), UserAgent(os_family='android').random(), UserAgent(phone=True).random()]
    ...
    if mobile_simulation:
        devices = ['Nexus 5', 'iPhone X', 'Nexus 4', 'Galaxy S5', 'iPad', 'iPad Pro', 'Pixel 2', 'Pixel 3', 'Nexus 6',
                   'iPhone XR', 'iPhone 12 Pro', 'iPhone 8', 'iPhone 14 Pro Max', 'iPhone 14 Pro', 'iPhone 14 Plus'
                   ]
    ...
    if proxy:
        ...
        ip = check_current_ip(driver, True)
